...
public class SpringAppTest {
	...
	public static void main(String[] args) {
		...
		=new ClassPathXmlApplicationContext("ex01/user_jdbc.xml");
		
		UserDAO dao=ctx.getBean("userDaoJdbc",UserDAO.class);
		/*int n=dao.createUser(new UserVO(0,"최길동","Choi2","111",new Date()));
		System.out.println((n>0)?"회원정보 등록 성공!!":"회원정보 등록 실패" );*/
		...
		int n=dao.deleteUser(5);
		System.out.println((n>0)?"삭제성공":"삭제 실패");
